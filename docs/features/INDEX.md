...
- [Bookmarks](bookmarks.md) - shared bookmark persistence and first headless TUI
  command surface.
...
- [Editing Mode](editing-mode.md) - completed Phase 2 Markdown-source viewer/editor workflow.
...
- [In-Document Search](in-document-search.md) - shared document search API and first TUI search workflow.
...
- [Tectonic `.tex` Support](tex-support.md) - Tectonic-backed full LaTeX
