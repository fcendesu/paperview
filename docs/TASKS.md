...
- In-Document Search currently covers shared case-insensitive line search, GUI header query with previous/next controls, and TUI `/`, `n`, and `N` navigation; match highlighting and exact rendered-line geometry are deferred.
