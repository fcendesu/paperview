...
- LaTeX Support currently covers structured inline math spans, a dedicated display math block, GUI and TUI readable previews for common display math tokens, Greek letters, arrows, set/logic operators, sums/integrals, compact scripts, source-preserving display math, and inline math export metadata; full formula typesetting is deferred.
